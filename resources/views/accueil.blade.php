@include('header_accueil')
            ...
            <div class="col-lg-6 align-self-center">
              <div class="owl-carousel owl-banner">
                <div class="item header-text">
                  <h6>Bienvenue sur EventPlanner</h6>
                  <h2>Organisez <em>votre événement</em> en toute simplicité</h2>
                  <p>Gérez tous les aspects de vos événements professionnels ou privés avec notre solution efficace.</p>
                ...
                <div class="item header-text">
                  <h6>Gestion d'événements en ligne</h6>
                  <h2>Découvrez les <em>meilleures solutions</em> pour <span>vos événements</span></h2>
                  <p>Nous offrons des outils performants pour planifier, organiser et suivre vos événements en temps réel.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
                ...
                <div class="item header-text">
                  <h6>Tutoriels en vidéo</h6>
                  <h2>Suivez <em>nos tutoriels</em> pour une gestion <span>efficace</span></h2>
                  <p>Apprenez à utiliser notre plateforme grâce à nos vidéos détaillées et améliorez vos compétences en gestion d'événements.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
                      <a href="#video">Voir les vidéos</a>
                    </div>
                    <div class="call-button">
  ...
  <div id="services" class="our-services section">
    <div class="services-right-dec">
      <img src="dist/assets/images/services-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="services-left-dec">
        <img src="dist/assets/images/services-left-dec.png" alt="">
      </div>
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-carousel owl-services">
            <div class="item">
              ...
              <div class="icon"><img src="dist/assets/images/service-icon-01.png" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
              <h4>Develop The Best Strategy for Business</h4>
              <div class="icon"><img src="dist/assets/images/service-icon-02.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>UI / UX Design and Development</h4>
              <div class="icon"><img src="dist/assets/images/service-icon-03.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>Discover &amp; Explore our SEO Tips</h4>
              <div class="icon"><img src="dist/assets/images/service-icon-04.png" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="event-card position-relative">
                ...
                <div class="price">200 TND</div>
                <div class="p-3">
                    <h5 class="mb-2">MACHINE LEARNING SESSIONS</h5>
                    <p class="event-location"><i class="bi bi-geo-alt"></i> Théâtre municipal de Tunis</p>
                    <p class="event-date"><i class="bi bi-calendar"></i> 01 Octobre 2024 à 19:00</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="event-card position-relative">
                <img src="assets/img/java.jpg" alt="Événement 2">
        ...
        <div class="col-md-4 mb-4">
            <div class="event-card position-relative">
                ...
                <div class="p-3">
                    ...
                    <p class="event-location"><i class="bi bi-geo-alt"></i> Pathé Mall of Sousse</p>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="dist/assets/images/about-left-image.png" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="dist/assets/images/service-icon-01.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="dist/assets/images/service-icon-02.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="dist/assets/images/service-icon-03.png" alt="">
                    </div>
  ...
  <div id="portfolio" class="our-portfolio section">
    <div class="portfolio-left-dec">
      <img src="dist/assets/images/portfolio-left-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="owl-carousel owl-portfolio">
            <div class="item">
              <div class="thumb">
                <img src="dist/assets/images/portfolio-01.jpg" alt="">
            ...
            <div class="item">
              <div class="thumb">
                <img src="dist/assets/images/portfolio-02.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="dist/assets/images/portfolio-03.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="dist/assets/images/portfolio-04.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
  ...
  <div id="pricing" class="pricing-tables">
    <div class="tables-left-dec">
      <img src="dist/assets/images/tables-left-dec.png" alt="">
    </div>
    <div class="tables-right-dec">
      <img src="dist/assets/images/tables-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
  ...
  <div id="video" class="our-videos section">
    <div class="videos-left-dec">
      <img src="dist/assets/images/videos-left-dec.png" alt="">
    </div>
    <div class="videos-right-dec">
      <img src="dist/assets/images/videos-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="menu">
                    <div class="active">
                      <div class="thumb">
                        <img src="dist/assets/images/video-thumb-01.png" alt="">
                        <div class="inner-content">
                          <h4>Project One</h4>
                          <span>SEO &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="dist/assets/images/video-thumb-02.png" alt="">
                        <div class="inner-content">
                    ...
                    <div>
                      <div class="thumb">
                        <img src="dist/assets/images/video-thumb-03.png" alt="Marketing">
                        <div class="inner-content">
                          <h4>Project Three</h4>
                          <span>Digital &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="dist/assets/images/video-thumb-04.png" alt="SEO Work">
                        <div class="inner-content">
  ...
  <div id="contact" class="contact-us section">
    ...
    <div class="contact-dec">
      <img src="dist/assets/images/contact-dec.png" alt="">
    </div>
    <div class="contact-left-dec">
      <img src="dist/assets/images/contact-left-dec.png" alt="">
    </div>
  </div>
